...
class HomeSectionByIdScreen extends StatelessWidget {
  final String? id;
  final String? name;

  HomeSectionByIdScreen({Key? key, this.id, this.name}) : super(key: key);
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    /// Ads
                    AdmobAds().bannerAds(),
                    StreamBuilder<HomeSectionbyIdModel?>(
                        stream: HttpService().getHomeSectionbyIdStream(id: id, userid: userController.userId),
