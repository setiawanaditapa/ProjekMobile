...
if ($searchInput != "") {
    $query = "SELECT COUNT(*) as num  FROM tbl_banner WHERE `banner_title` LIKE '%$searchInput%'";
...
if ($searchInput != "") {
    $sql_query = "SELECT * FROM tbl_banner WHERE `banner_title` LIKE '%$searchInput%' ORDER BY tbl_banner.`bid` DESC LIMIT $start, $limit";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td scope="row">
                                                <?php
                                                $banner_songs = explode(',', $row['banner_songs']);
                                                foreach ($banner_songs as $banner_song) {
                                                    if (isset($mp3s[$banner_song])) {
                                                        _e($mp3s[$banner_song] . ",");
                                                    }
                                                }
                                                ?>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <img type="image" src="images/thumbs/<?php _e($row['banner_image']); ?>" class="image_size" alt="image" />
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($row['status'] != "0") { ?>
