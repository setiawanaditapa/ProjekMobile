...
if ($searchInput != "") {
    $sql_query = "SELECT * FROM tbl_artist WHERE `artist_name` LIKE '%$searchInput%' ORDER BY tbl_artist.`id` DESC LIMIT $start, $limit";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } else { ?>
                                                    <img type="image" src="images/thumbs/<?php _e($row['artist_image']); ?>" class="image_size" alt="image" />
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($row['a_status'] != "0") { ?>
                                                    <a title="Change Status" class="toggle_btn_a" href="javascript:void(0)" data-id="<?php _e($row['id']); ?>" data-action="deactive" data-column="a_status"><span class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i><span>Enable</span></span></a>

                                                <?php } else { ?>
                                                    <a title="Change Status" class="toggle_btn_a" href="javascript:void(0)" data-id="<?php _e($row['id']); ?>" data-action="active" data-column="a_status"><span class="btn btn-danger"><i class="fa fa-check" aria-hidden="true"></i><span>Disable </span></span></a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <a href="add_artist.php?artist_id=<?php _e($row['id']); ?>" class="btn btn-primary">
