<?php
	...
	// for account blocked
	$app_lang['account_blocked']="Sorry ! Your account is blocked";

	// for account delete
	$app_lang['user_deleted']="Sorry ! Your account is deleted";
	...
	// suggest messages
	$app_lang['suggest_success']="Your have successfully submitted your suggestion, it will be reviewed by admin and will uploaded if necessary";
